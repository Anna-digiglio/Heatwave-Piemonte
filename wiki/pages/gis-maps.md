...
|---|---|---|
| `temperature_heatmap.qgz` | Coropletica della temperatura media sui 599 comuni con dati reali | ✅ generata e verificata |
| `hotspot_analysis.qgz` | Cluster climatici K-means (k=3, da `spatial_analysis.py`) | ✅ generata e verificata — pattern geografico ora nitido (alpino/intermedio/pianura); rigenerata il 2026-07-16 con etichette cluster 0/1/2 rinumerate per temperatura crescente e colori blu→arancio→rosso coerenti, rigenerata due volte il 2026-07-17 (63 poi 98 comuni), **due volte il 2026-07-18 (155 poi 177 comuni)** e **il 2026-07-23 (234 poi 599 comuni)** (vedi [Analisi Statistica](statistical-analysis.md)) |
...
**Nota di granularità**: tutte le mappe mostrano i **599 comuni con dati
reali** a colori (8 capoluoghi + 591 extra, esteso 2026-07-15 → 2026-07-23
...
nasconderla. **Rigenerate ripetutamente** (`python-qgis-ltr.bat
build_maps.py`) a ogni estensione della copertura, l'ultima volta il
2026-07-23 dopo il giro unico di import 234 → 599 comuni — stesso script,
nessuna modifica necessaria oltre ai colori dei cluster già documentati
sopra.
...
- Eventualmente costruire la mappa "Heatwave Index" (non fatta in questa
  sessione)
- Se si vuole coprire più dei 599 comuni attuali, servirebbe scaricare
