...
- [Dashboard](pages/dashboard.md) — dashboard Streamlit, **implementata, eseguita su dati reali e ampliata** (6 pagine, mappe coropletiche PostGIS), **restyling identità "calore" 2026-07-17**, **nuova pagina "Validazione Dati" 2026-07-18** (confronto Open-Meteo vs ARPA)
